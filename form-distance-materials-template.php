						...
						<div class="entry-content welshimer-form">
								...
								<?php the_content(); ?>
									...
									<form action="<?php the_permalink(); ?>" method="post">
										<p class="form"><label class="label" for="patron_name">Name:* </label><input tabindex="5" class="text three-fourths<?php if(isset($nameError)){echo ' fail';}?>" type="text" id="patron_name" name="patron_name" value="<?php if(isset($patron_name)){echo $patron_name;} ?>"/></p>
										<p class="form"><label class="label" for="patron_barcode">Barcode:* </label><input tabindex="6" class="text three-fourths<?php if(isset($barcodeError)){echo ' fail';}?>" type="text" id="patron_barcode" name="patron_barcode" value="<?php if(isset($patron_barcode)){echo $patron_barcode;} ?>"/></p>
										<p class="form"><label class="label" for="patron_email">Milligan Email:* </label><input tabindex="7" class="text three-fourths<?php if(isset($emailError)){echo ' fail';}?>" type="text" id="patron_email" name="patron_email" value="<?php if(isset($patron_email)){echo $patron_email;} ?>" /></p>
										<p class="form"><label class="label" for="item_title">Item Title:* </label><input tabindex="8" class="text<?php if(isset($titleError)){echo ' fail';}?>" type="text" id="item_title" name="item_title" value="<?php if(isset($item_title)){echo $item_title;} ?>" /></p>
										<p class="form"><label class="label" for="item_author">Item Author:* </label><input tabindex="9" class="text<?php if(isset($authorError)){echo ' fail';}?>" type="text" id="item_author" name="item_author" value="<?php if(isset($item_author)){echo $item_author;} ?>" /></p>
										<p class="form"><label class="label" for="item_call_number">Call Number:* </label><input tabindex="10" class="text three-fourths<?php if(isset($callNumberError)){echo ' fail';}?>" type="text" id="item_call_number" name="item_call_number" value="<?php if(isset($item_call_number)){echo $item_call_number;} ?>" /></p>
										<p class="laylah"><label for="laylah">Required</label><input type="text" id="laylah" name="laylah" tabindex="999" /></p>
										<p class="form"><label class="label" for="patron_address">Street Address:* </label><input tabindex="11" class="text three-fourths<?php if(isset($addressError)){echo ' fail';}?>" type="text" id="patron_address" name="patron_address" value="<?php if(isset($patron_address)){echo $patron_address;} ?>" /></p>
										<p class="form"><label class="label" for="patron_city">City:* </label><input tabindex="12" class="text quarter<?php if(isset($cityError)){echo ' fail';}?>" type="text" id="patron_city" name="patron_city" value="<?php if(isset($patron_city)){echo $patron_city;} ?>" /></p>
                              <p class="form"><label class="label" for="patron_state">State:* </label><input tabindex="12" class="text quarter<?php if(isset($stateError)){echo ' fail';}?>" type="text" id="patron_state" name="patron_state" value="<?php if(isset($patron_state)){echo $patron_state;} ?>" /></p>
                              <p class="form"><label class="label" for="patron_zip">Zip:* </label><input tabindex="12" class="text quarter<?php if(isset($zipError)){echo ' fail';}?>" type="text" id="patron_zip" name="patron_zip" value="<?php if(isset($patron_zip)){echo $patron_zip;} ?>" /></p>
										<p class="form"><label class="label" for="patron_message">Special Instructions: </label><textarea tabindex="13" class="textarea" id="patron_message" name="patron_message" ><?php if(isset($patron_message)){echo $patron_message;} ?></textarea></p>
